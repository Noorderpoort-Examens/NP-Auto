    ...
    <div class="grid md:grid-cols-2 gap-3 md:gap-8 lg:gap-10 mt-3 md:mt-4 lg:mt-5">
        ...
        <div>
            ...
            <form class="bg-np-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div class="mb-4">
                    <label class="block text-np-dark text-sm md:text-base lg:text-lg font-bold mb-2 uppercase" for="name">
                        Naam
                    </label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-np-dark leading-tight focus:outline-none focus:shadow-outline" id="name" type="text" placeholder="Vul hier je naam in">
                </div>
                <div class="mb-4">
                    <label class="block text-np-dark text-sm md:text-base lg:text-lg font-bold mb-2 uppercase" for="email">
                        Email
                    </label>
                    <input class="shadow appearance-none border rounded w-full py-2 px-3 text-np-dark leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Vul hier je email in">
                </div>
                <div class="mb-4">
                    <label class="block text-np-dark text-sm md:text-base lg:text-lg font-bold mb-2 uppercase" for="username">
                        Bericht
                    </label>
                    <textarea id="message" rows="4" class="shadow appearance-none border rounded w-full py-2 px-3 text-np-dark leading-tight focus:outline-none focus:shadow-outline" placeholder="Vul hier je bericht in..."></textarea>
                </div>
                <div class="flex items-center justify-center">
                    <button class="bg-np-dark hover:bg-np-yellow text-white font-bold py-2 px-4 text-sm md:text-base lg:text-lg rounded focus:outline-none focus:shadow-outline transition duration-150 ease-in-out" type="submit">
